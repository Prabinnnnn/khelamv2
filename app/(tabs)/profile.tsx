      ...
      >
        ...
        {user.hostStatus === "not_applied" ? (
          <TouchableOpacity
            style={[
              styles.hostCard,
              { backgroundColor: "#C8F24818", borderColor: "#C8F24860" },
            ]}
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={[styles.hostTitle, { color: colors.foreground }]}>
                Become a Host
              </Text>
          ...
          <TouchableOpacity
            style={[
              styles.hostCard,
              { backgroundColor: "#DCFCE722", borderColor: "#22C55E44" },
            ]}
        ...
        <TouchableOpacity
          style={[
            styles.signOut,
            { borderColor: "#FF4D4D22", backgroundColor: "#FF4D4D0A" },
          ]}
